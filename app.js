...
// Complete the exercise in the space below:
inventorNames = inventors.map((insv) => {
  return { first: insv.first, last: insv.last }
})
// Check your work:
...
// Complete the exercise in the space below:
sortedByBirthYear = inventors.sort((x, y) => {
...
// Complete the exercise in the space below:
firstLast = people.map((nam) => {
  let [first, last] = nam.split(' ,')
  return `${first}${last}`
})
// Check your work:
...
// Complete the exercise in the space below:
isAdultPresent = devs.some((oldd) => {
  return 2024 - oldd.year >= 18
})
// Check your work:
...
// Complete the exercise in the space below:
isEveryone19OrOlder = devs.every((olddd) => {
  return 2024 - olddd.year === 19
})
// Check your work:
...
// Complete the exercise in the space below:
commentById = comments.find((idd) => {
  return idd.id === 823423
})
// Check your work:
